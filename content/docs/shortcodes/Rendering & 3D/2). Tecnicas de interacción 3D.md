...
{{< hint info >}} 
## Conclusiones
* Los gráficos por ordenador en 3D han conseguido introducirse en la vida de todos nosotros. Expresar la información a través de la visualización en 3D está aportando enormes beneficios para una variedad de aplicaciones que van desde los videojuegos, pasando por los últimos efectos especiales en las películas, hasta aplicaciones serias (por ejemplo, visualizaciones de ingeniería)

* Se ha dedicado un gran interés de investigación a los gráficos por ordenador en 3D; sin embargo, la mayor parte de este esfuerzo de investigación se ha centrado en los
aspectos técnicos y de aplicación. Hace falta abordar mas la investigacion en cómo los usuarios interactúan con los entornos 3D y sólo hay unos pocos trabajos relacionados con enfoques de clasificación en el campo de las técnicas de interacción 3D.

## Trabajos futuros
* Fundamentos del diseño de la interfaz de usuario de la Web en 3D. Comprensión de las tareas
fundamentales que los usuarios pueden realizar mientras exploran los entornos virtuales 3D basados en la Web
